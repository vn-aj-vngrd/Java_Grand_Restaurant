...
public class DrinksMenu extends javax.swing.JFrame {
    ...
    public DrinksMenu(double total, int customerID) {
        initComponents();
        this.total = total;
        this.customerID = customerID;
        totalField.setText("PHP " + String.format("%.2f", total));
        cc.fetchMenu(menuTable, "drinks");
    ...
    private void initComponents() {
        ...
        title.setText("Select your Drinks");
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        ...
        int input = JOptionPane.showConfirmDialog(null,
                "Do you want to proceed to check out?", "Grand Restaurant Confirmation", JOptionPane.YES_NO_CANCEL_OPTION);
        if (input == 0) {
            CheckOut c = new CheckOut(total, customerID);

            c.setVisible(true);
            c.setTitle("Grand Restaurant");
            dispose();
        }
