 ...
 */
public class OrderCancelled extends javax.swing.JFrame {
     ...
     */
    public OrderCancelled(int empID) {
        initComponents();
        this.empID = empID;
        oc.fetchOrder("cancelled", orderTable);
    }
    ...
    private void initComponents() {
        ...
        cancelled.setBackground(new java.awt.Color(102, 102, 255));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(exportExcel, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(91, 91, 91))
        );
        ...
        jLabel4.setText("Cancelled Orders");
    ...
    private void completedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_completedActionPerformed
        // TODO add your handling code here:
        OrderCompleted ocp = new OrderCompleted(empID);
        ocp.setVisible(true);
        ocp.setTitle("Grand Restaurant - Employee");
        dispose();
    ...
    private void exportPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportPDFActionPerformed
        ...
        if (response == JFileChooser.APPROVE_OPTION) {
            ...
            Boolean b = oc.exportAsPDF("cancelled", filepath);
            if (b) {
    ...
    private void exportExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportExcelActionPerformed
        ...
        if (response == JFileChooser.APPROVE_OPTION) {
            File filepath = new File(fc.getSelectedFile().getAbsolutePath());
            Boolean b = oc.exportAsCSV("cancelled", filepath);
            if (b) {
