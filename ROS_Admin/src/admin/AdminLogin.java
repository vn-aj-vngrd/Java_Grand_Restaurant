...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        usernameTitle.setFont(new java.awt.Font("Montserrat Light", 0, 16)); // NOI18N
        ...
        passwordTitle.setFont(new java.awt.Font("Montserrat Light", 0, 16)); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        // TODO add your handling code here:
        int adminID = ac.loginValidation(usernameField, passwordField);
        if (adminID > 0) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                l.setVisible(true);
                l.setTitle("Grand Restaurant - Administrator");
            }
        });
    }
